...
dat$Vehicle.Movement = facor(dat$Vehicle.Movement)
dat$Vehicle.Body.Type = facor(dat$Vehicle.Body.Type)
dat$Vehicle.Damage.Extent = facor(dat$Vehicle.Damage.Extent)
dat$Light = facor(dat$Light)
